...
ServerAuthInfo::ServerAuthInfo(const fastotv::user_id_t& uid, const AuthInfo& auth) : base_class(auth), uid_(uid) {}
...
fastotv::user_id_t ServerAuthInfo::GetUserID() const {
  return uid_;
}
